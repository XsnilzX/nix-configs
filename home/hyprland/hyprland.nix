{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      env = HYPRSHOT_DIR,/home/xsnilzx/Bilder/Screenshot
      env = QT_QPA_PLATFORMTHEME,qt5ct
      ...
      misc {
          ...
          vfr = true # weniger Frames wenn sich nichts ändert
      }
      ...
      bind = $mainMod+SHIFT, S, exec, wayshot -f /home/xsnilzx/Bilder/screenshots/$(date '+%Y%m%d-%H:%M:%S').png
      bind = $mainMod, S, exec, wayshot -s "$(slurp)" -f /home/xsnilzx/Bilder/screenshots/$(date '+%Y%m%d-%H:%M:%S').png
  ...
  home = {
    ...
    file."Bilder/Wallpaper/wallpaper.png".source = ./../../machines/nixspo/wallpaper.png;
  ...
  programs.hyprshot = {
    enable = true;
    saveLocation = "${config.home.homeDirectory}/Bilder/Screenshots";
  };
}
